...
function essayScroll() {
  ...
  (p.offsetTop + p.offsetHeight / 2 < r || 90 < waterfallResult) &&
    (percentFlag = true);
}
...
var icatessay = {
  diffDate: function (d, more = false) {
    ...
    const secSuffix = suffix.second || "秒钟前";
    ...
    if (more) {
      ...
      const secondCount = dateDiff / second;
      ...
      if (monthCount >= 1) {
        ...
        result = parseInt(secondCount) + " " + secSuffix;
      } else {
        result = suffix.just;
      }
    } else {
  ...
  changeTimeInEssay: function () {
    document.querySelector("#icat-bber") &&
      document.querySelectorAll("#icat-bber time").forEach(function (e) {
        ...
        (t.innerText = icatessay.diffDate(datetime, true)),
